...
INSERT INTO `product_criteria` VALUES ('0002', '巧克力', '可可制品、巧克力和巧克力制品、以及糖果', '每单位：00001（30%，2--公斤）；00002（40%，3000--毫升）；00005（30%，15--袋）', '5--天', '3--年', '500', '0', '/0002-01.png；/0002-02.png；/0002-03.png；/0002-04.png');
INSERT INTO `product_criteria` VALUES ('0003', '章鱼小丸子', '水产品及其制品', '每单位：00071（50%，12--个）；00014（20%，6--毫升）；00035（30%，15--根）', '1--天', '3--天', '20', '0', '/0003-01.png；/0003-02.png');
